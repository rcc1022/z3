...
@Component(WithdrawModel.NAME + ".model")
@Scope(BeanDefinition.SCOPE_PROTOTYPE)
@Entity(name = WithdrawModel.NAME)
@Table(name = "t_player_withdraw")
public class WithdrawModel extends ModelSupport {
    static final String NAME = "eagle.player.withdraw";

    private String player; // 玩家
    private int type; // 类型：0-微信；1-支付宝；2-银行卡；3-手动
